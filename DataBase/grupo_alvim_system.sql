...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27-Jan-2025 às 00:57
...
--
-- Banco de dados: `grupo_alvim_system`
--
...
INSERT INTO `cargos` (`ID`, `nome_cargo`, `nivel_acesso`) VALUES
(1, 'Administrador', 1),
(2, 'Vendedor', 2),
(3, 'Gerente Loja', 3),
(4, 'Contabilidade', 4),
...
INSERT INTO `empresas` (`id`, `numero_loja`, `cnpj`, `razao_social`, `nome_fantasia`, `endereco`, `cidade`, `uf`, `cep`, `bairro`, `telefone`, `email`, `data_criacao`, `status`, `createdAt`, `updatedAt`) VALUES
(1, 123, '26.428.809/0001-02', 'Imperador Alvim Comercio De Alimentos Ltda', 'Burger King Imperador', 'Quadra SCRN 706/707 Bloco e Nr, 32', 'BRASILIA', 'DF', '70740-650', 'ASA NORTE', '(61) 3034-4556', 'adm@planetacontabil.com.br', '2025-01-26 17:25:54', 'ativo', NULL, NULL);
...
INSERT INTO `users` (`ID`, `nome`, `email`, `senha`, `loja`, `cargo`, `token`, `data_criacao`, `data_atualizacao`, `status`, `telefone`, `ultimo_login`) VALUES
(1, 'Haurio Vieira', 'hauriovieira@gmail.com', '123', 1, 1, NULL, '2025-01-26 18:14:51', '2025-01-26 18:14:51', 'ativo', '910800056', NULL);
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`loja`) REFERENCES `empresas` (`ID`),
  ADD CONSTRAINT `users_ibfk_2` FOREIGN KEY (`cargo`) REFERENCES `cargos` (`ID`);
COMMIT;
